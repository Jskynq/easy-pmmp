...
O PocketMine-MP aceita contribuições da comunidade! Os seguintes recursos serão úteis se você quiser contribuir para o PocketMine-MP. Acesse [Repositório oficial do PocketMine-MP](https://github.com/pmmp/PocketMine-MP) para ver o que você pode fazer para se familiarizar com a base do código. 
